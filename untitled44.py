...
def enterRoom():
    ...
    message_label = Label(message_window, text="Message " , font = 'arial' 13),
bg='#AFC1D6', fg="white"
    message_label.text(relx=0.3,rely=0.8, anchor=CENTER)
    
    message_entry = Entry(message_window, font = 'arial 15')
    message_entry.place(relx=0.6,rely=0.8, anchor=CENTER)
    
    btn_send = Button(message_window, text="Send", font = 'arial 13', bg="#D6CA98"),
fg="black", padx=10, relief=FLAT
    btn_send.place(relx=0.5,rely=0.9, anchor=CENTER)
    
    message_window.mainloop()
    
username_label = Label(login_window, text="Username : " , font = 'arial 13', bg ='#AB92BF'),
fg="white")
username_label.place(relx=0.3,rely=0.3, anchor=CENTER)
    
username_entry = Entry(login_window)
username_label.place(relx=0.6,rely=0.3, anchor=CENTER)

your_code_label = label(login_window, text="Your code : ",  = font = 'arial 13', bg
='#AB92BF', fg="white")
...
friends_code_label = Label(login_window, text="Your Friend's code :  ",font = 'arial 13',
                           )